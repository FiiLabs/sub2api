...
// 兜底串要跟着键一起改：翻译缺失时退回的那个词如果还是旧名字，
// 就会在同一个界面上把已经分开的两笔钱重新叫成同一个名字。
const balanceAvailableText = computed(() => t('common.availableBalance') === 'common.availableBalance' ? '账户余额' : t('common.availableBalance'))
