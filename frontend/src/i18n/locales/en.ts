export default {
  ...
  members: {
    ...
    acceptLinkHint: 'Share this link with the invitee. It only works for the invited email.',
    copyLink: 'Copy link',
    ...
    transferConfirm: 'Transfer ownership of this team to {user}? You will become an admin.',
  ...
  acceptInvitation: {
    ...
    missingToken: 'This invitation link is invalid or incomplete.',
    invalid: 'This invitation is invalid or no longer exists.',
    expired: 'This invitation has expired. Ask a team admin to send a new one.',
    alreadyHandled: 'This invitation is no longer pending.',
    emailMismatch: 'This invitation was sent to {email}. Sign in with that account to accept it.',
