  ...
  proof: {
    ...
    e2ee: {
      ...
      live: {
        ...
        claimBody: '你的提问在你的浏览器里就被加密成一串密文,只有上方那台通过硬件证明的机密电脑能解开。网络、TLS 终止点、任何中间环节经手的都是这串密文——读不到你的内容。它能把密文解开并加密回信,就证明了这一点。(注:解密后,机密电脑会按设计把你的提问明文转发给上游模型服务商——见诚实说明。)',
        ...
        successNote: '你的提问在浏览器里被加密给机密电脑的专属钥匙、完成了一次真实推理往返、且加密回复通过了校验解密。任何中间环节(网络、TLS 终止点)都没看到你的明文。',
