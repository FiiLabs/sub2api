export default {
  ...
  members: {
    ...
    inviteFailed: '创建邀请失败',
    acceptLink: '接受链接',
    acceptLinkHint: '将此链接分享给受邀者，链接仅对受邀邮箱有效。',
    copyLink: '复制链接',
    linkCopied: '接受链接已复制',
    suspend: '停用',
    activate: '启用',
    ...
    transferTitle: '转让所有权',
    transferConfirm: '确定将该团队的所有权转让给 {user} 吗？转让后你将成为管理员。',
    transferSuccess: '所有权已转让',
    failedToTransfer: '转让所有权失败',
    loadFailed: '加载团队成员失败'
  },
  ...
  acceptInvitation: {
    ...
    accept: '接受邀请',
    accepting: '加入中...',
    acceptSuccess: '您已加入团队',
    decline: '暂不加入',
    backToDashboard: '返回仪表盘',
    missingToken: '邀请链接无效或不完整。',
    invalid: '该邀请无效或已不存在。',
    expired: '该邀请已过期，请联系团队管理员重新发送。',
    alreadyHandled: '该邀请已不再处于待处理状态。',
    emailMismatch: '该邀请发送给 {email}，请使用该账号登录后再接受。',
    acceptFailed: '接受邀请失败。'
  },
