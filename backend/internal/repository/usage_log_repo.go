...
func prepareUsageLogInsert(log *service.UsageLog) usageLogInsertPrepared {
	...
	return usageLogInsertPrepared{
		...
		args: []any{
			...
			sql.NullInt64{Int64: log.BillingSubjectID, Valid: log.BillingSubjectID > 0}, // billing_subject_id
			nullInt64(log.TeamID),                                                        // team_id
			nullInt64(log.ActorUserID),                                                   // actor_user_id
			createdAt,
		},
	}
}
