	...
	m, err := r.activeQuery().
		...
		WithGroup(func(q *dbent.GroupQuery) {
			q.Select(
				...
				group.FieldDynamicRateEnabled,
				group.FieldDynamicRateMode,
				group.FieldDynamicRateMargin,
				group.FieldDynamicRateMinMultiplier,
				group.FieldDynamicRateMaxMultiplier,
...
func groupEntityToService(g *dbent.Group) *service.Group {
	...
	return &service.Group{
		...
		DynamicRateMode:                 g.DynamicRateMode,
		DynamicRateMargin:               g.DynamicRateMargin,
