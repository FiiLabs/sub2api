...
func (r *paymentOrderLifecycleRedeemRepo) ListBySubjectID(_ context.Context, subjectID int64, params pagination.PaginationParams, codeType string) ([]RedeemCode, *pagination.PaginationResult, error) {
