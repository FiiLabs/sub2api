...
func (s *apiKeyRepoStubForGroupUpdate) GetByKeyHash(context.Context, string) (*APIKey, error) {
	panic("unexpected")
}
...
func (s *apiKeyRepoStubForGroupUpdate) ListKeysByTeamID(context.Context, int64) ([]string, error) {
	return nil, nil
}
func (s *apiKeyRepoStubForGroupUpdate) DeleteByTeamID(ctx context.Context, teamID int64) ([]string, error) {
	return nil, nil
}
