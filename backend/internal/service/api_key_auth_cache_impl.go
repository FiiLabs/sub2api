...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			DynamicRateEnabled:              apiKey.Group.DynamicRateEnabled,
			DynamicRateMode:                 apiKey.Group.DynamicRateMode,
			DynamicRateMargin:               apiKey.Group.DynamicRateMargin,
			DynamicRateMinMultiplier:        apiKey.Group.DynamicRateMinMultiplier,
			DynamicRateMaxMultiplier:        apiKey.Group.DynamicRateMaxMultiplier,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			DynamicRateEnabled:              snapshot.Group.DynamicRateEnabled,
			DynamicRateMode:                 snapshot.Group.DynamicRateMode,
			DynamicRateMargin:               snapshot.Group.DynamicRateMargin,
			DynamicRateMinMultiplier:        snapshot.Group.DynamicRateMinMultiplier,
			DynamicRateMaxMultiplier:        snapshot.Group.DynamicRateMaxMultiplier,
