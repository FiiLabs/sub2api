...
func (f fakeAPIKeyRepo) GetByKeyHash(ctx context.Context, hash string) (*service.APIKey, error) {
	return nil, errors.New("not implemented")
}
...
func (f fakeGoogleSubscriptionRepo) ListByBillingSubjectID(ctx context.Context, billingSubjectID int64) ([]service.UserSubscription, error) {
	return nil, nil
}
func (f fakeGoogleSubscriptionRepo) ListActiveByBillingSubjectID(ctx context.Context, billingSubjectID int64) ([]service.UserSubscription, error) {
	return nil, nil
}
