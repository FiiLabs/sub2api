...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	supplierWithdrawalService := service.NewSupplierWithdrawalService(supplierWithdrawalRepository, supplierCreditRepository, settingService)
