...
// The BillingSubjectFunc type is an adapter to allow the use of ordinary function as a Querier.
type BillingSubjectFunc func(context.Context, *ent.BillingSubjectQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f BillingSubjectFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.BillingSubjectQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.BillingSubjectQuery", q)
}

// The TraverseBillingSubject type is an adapter to allow the use of ordinary function as Traverser.
type TraverseBillingSubject func(context.Context, *ent.BillingSubjectQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseBillingSubject) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseBillingSubject) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.BillingSubjectQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.BillingSubjectQuery", q)
}
...
// The RedeemAuditLogFunc type is an adapter to allow the use of ordinary function as a Querier.
type RedeemAuditLogFunc func(context.Context, *ent.RedeemAuditLogQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f RedeemAuditLogFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.RedeemAuditLogQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.RedeemAuditLogQuery", q)
}

// The TraverseRedeemAuditLog type is an adapter to allow the use of ordinary function as Traverser.
type TraverseRedeemAuditLog func(context.Context, *ent.RedeemAuditLogQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseRedeemAuditLog) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseRedeemAuditLog) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.RedeemAuditLogQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.RedeemAuditLogQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.BillingSubjectQuery:
		return &query[*ent.BillingSubjectQuery, predicate.BillingSubject, billingsubject.OrderOption]{typ: ent.TypeBillingSubject, tq: q}, nil
	...
	case *ent.RedeemAuditLogQuery:
		return &query[*ent.RedeemAuditLogQuery, predicate.RedeemAuditLog, redeemauditlog.OrderOption]{typ: ent.TypeRedeemAuditLog, tq: q}, nil
