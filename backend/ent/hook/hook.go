...
// The BillingSubjectFunc type is an adapter to allow the use of ordinary
// function as BillingSubject mutator.
type BillingSubjectFunc func(context.Context, *ent.BillingSubjectMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f BillingSubjectFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.BillingSubjectMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.BillingSubjectMutation", m)
}
...
// The RedeemAuditLogFunc type is an adapter to allow the use of ordinary
// function as RedeemAuditLog mutator.
type RedeemAuditLogFunc func(context.Context, *ent.RedeemAuditLogMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f RedeemAuditLogFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.RedeemAuditLogMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.RedeemAuditLogMutation", m)
}
