...
type RedeemCode struct {
	...
	// 非空表示该记录归属某计费主体（团队余额调整审计）；个人余额记录为空
...
func (*RedeemCode) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case redeemcode.FieldID, redeemcode.FieldUsedBy, redeemcode.FieldGroupID, redeemcode.FieldValidityDays, redeemcode.FieldBillingSubjectID:
