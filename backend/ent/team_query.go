...
type TeamQuery struct {
	...
	withTeamSubject    *BillingSubjectQuery
...
func (_q *TeamQuery) QueryCreatedBy() *UserQuery {
	query := (&UserClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *TeamQuery) QueryBillingSubject() *BillingSubjectQuery {
...
// QueryTeamSubject chains the current query on the "team_subject" edge.
func (_q *TeamQuery) QueryTeamSubject() *BillingSubjectQuery {
	query := (&BillingSubjectClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *TeamQuery) QueryPaymentOrders() *PaymentOrderQuery {
...
func (_q *TeamQuery) Clone() *TeamQuery {
	...
	return &TeamQuery{
		...
		withTeamSubject:    _q.withTeamSubject.Clone(),
...
func (_q *TeamQuery) WithCreatedBy(opts ...func(*UserQuery)) *TeamQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *TeamQuery) WithBillingSubject(opts ...func(*BillingSubjectQuery)) *TeamQuery {
	query := (&BillingSubjectClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithTeamSubject tells the query-builder to eager-load the nodes that are connected to
// the "team_subject" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *TeamQuery) WithTeamSubject(opts ...func(*BillingSubjectQuery)) *TeamQuery {
	query := (&BillingSubjectClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withTeamSubject = query
	return _q
}
...
func (_q *TeamQuery) WithPaymentOrders(opts ...func(*PaymentOrderQuery)) *TeamQuery {
	query := (&PaymentOrderClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *TeamQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Team, error) {
	...
	if query := _q.withCreatedBy; query != nil {
		if err := _q.loadCreatedBy(ctx, query, nodes, nil,
			func(n *Team, e *User) { n.Edges.CreatedBy = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withBillingSubject; query != nil {
		if err := _q.loadBillingSubject(ctx, query, nodes, nil,
			func(n *Team, e *BillingSubject) { n.Edges.BillingSubject = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withTeamSubject; query != nil {
		if err := _q.loadTeamSubject(ctx, query, nodes,
			func(n *Team) { n.Edges.TeamSubject = []*BillingSubject{} },
			func(n *Team, e *BillingSubject) { n.Edges.TeamSubject = append(n.Edges.TeamSubject, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withPaymentOrders; query != nil {
		if err := _q.loadPaymentOrders(ctx, query, nodes,
			func(n *Team) { n.Edges.PaymentOrders = []*PaymentOrder{} },
			func(n *Team, e *PaymentOrder) { n.Edges.PaymentOrders = append(n.Edges.PaymentOrders, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *TeamQuery) loadCreatedBy(ctx context.Context, query *UserQuery, nodes []*Team, init func(*Team), assign func(*Team, *User)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*Team)
	for i := range nodes {
...
func (_q *TeamQuery) loadBillingSubject(ctx context.Context, query *BillingSubjectQuery, nodes []*Team, init func(*Team), assign func(*Team, *BillingSubject)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*Team)
	for i := range nodes {
...
func (_q *TeamQuery) loadTeamSubject(ctx context.Context, query *BillingSubjectQuery, nodes []*Team, init func(*Team), assign func(*Team, *BillingSubject)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(billingsubject.FieldTeamID)
	}
	query.Where(predicate.BillingSubject(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(team.TeamSubjectColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *TeamQuery) loadPaymentOrders(ctx context.Context, query *PaymentOrderQuery, nodes []*Team, init func(*Team), assign func(*Team, *PaymentOrder)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*Team)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(paymentorder.FieldTeamID)
	}
	query.Where(predicate.PaymentOrder(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(team.PaymentOrdersColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *TeamQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withOwner != nil {
			_spec.Node.AddColumnOnce(team.FieldOwnerUserID)
		}
		if _q.withCreatedBy != nil {
			_spec.Node.AddColumnOnce(team.FieldCreatedByUserID)
		}
		if _q.withBillingSubject != nil {
			_spec.Node.AddColumnOnce(team.FieldBillingSubjectID)
		}
	}
