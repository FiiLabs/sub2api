...
func (_q *APIKeyQuery) QueryBillingSubject() *BillingSubjectQuery {
...
func (_q *APIKeyQuery) QueryTeam() *TeamQuery {
...
func (_q *APIKeyQuery) QueryUpdatedBy() *UserQuery {
	query := (&UserClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *APIKeyQuery) WithBillingSubject(opts ...func(*BillingSubjectQuery)) *APIKeyQuery {
	query := (&BillingSubjectClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *APIKeyQuery) WithTeam(opts ...func(*TeamQuery)) *APIKeyQuery {
	query := (&TeamClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *APIKeyQuery) WithUpdatedBy(opts ...func(*UserQuery)) *APIKeyQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *APIKeyQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*APIKey, error) {
	...
	if query := _q.withBillingSubject; query != nil {
		if err := _q.loadBillingSubject(ctx, query, nodes, nil,
			func(n *APIKey, e *BillingSubject) { n.Edges.BillingSubject = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withTeam; query != nil {
		if err := _q.loadTeam(ctx, query, nodes, nil,
			func(n *APIKey, e *Team) { n.Edges.Team = e }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withUpdatedBy; query != nil {
		if err := _q.loadUpdatedBy(ctx, query, nodes, nil,
			func(n *APIKey, e *User) { n.Edges.UpdatedBy = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *APIKeyQuery) loadBillingSubject(ctx context.Context, query *BillingSubjectQuery, nodes []*APIKey, init func(*APIKey), assign func(*APIKey, *BillingSubject)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*APIKey)
	for i := range nodes {
...
func (_q *APIKeyQuery) loadTeam(ctx context.Context, query *TeamQuery, nodes []*APIKey, init func(*APIKey), assign func(*APIKey, *Team)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*APIKey)
	for i := range nodes {
...
func (_q *APIKeyQuery) loadUpdatedBy(ctx context.Context, query *UserQuery, nodes []*APIKey, init func(*APIKey), assign func(*APIKey, *User)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*APIKey)
	for i := range nodes {
		if nodes[i].UpdatedByUserID == nil {
			continue
		}
...
func (_q *APIKeyQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withBillingSubject != nil {
			_spec.Node.AddColumnOnce(apikey.FieldBillingSubjectID)
		}
		if _q.withTeam != nil {
			_spec.Node.AddColumnOnce(apikey.FieldTeamID)
		}
		if _q.withCreatedBy != nil {
			_spec.Node.AddColumnOnce(apikey.FieldCreatedByUserID)
		}
		if _q.withUpdatedBy != nil {
			_spec.Node.AddColumnOnce(apikey.FieldUpdatedByUserID)
		}
	}
